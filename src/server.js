...
app.use(cors({ origin: process.env.CORS_ORIGIN || '*', methods: ['GET','POST','PATCH','PUT','DELETE'], allowedHeaders: ['Content-Type','Authorization'] }));
...
app.use('/api/shops',     require('./modules/products/products.router'));
